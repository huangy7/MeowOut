...
<p align="center">
  ...
  <a href="https://github.com/huangy7/MeowOut/releases/latest">
    <img src="https://img.shields.io/badge/📦_立即下载-MeowOut_v1.3.3-0071e3?style=for-the-badge&labelColor=001a3d" alt="Download">
  </a>
</p>
...
| 特性 | 说明 |
| :--- | :--- |
| **多样化像素伙伴** | 内置 **Clawd (小猫)**、**Robot (机器人)**、**Cloud (云朵)**、**Horse (小金马)** 及 **Fomo (小狐狸)** 等多款宠物，支持实时切换与独立动画。 |
