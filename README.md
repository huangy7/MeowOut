...
| 特性 | 说明 |
| :--- | :--- |
| **多样化像素伙伴** | 内置 **Clawd (小猫)**、**Robot (机器人)**、**Cloud (云朵)** 及 **Horse (小金马)** 等多款宠物，支持实时切换与独立动画。 |
...
Sources/MeowOut/
  ...
  Views/                      # 各类视图组件 (Clawd, Robot, Cloud, Horse...)
...
像素精灵渲染组件（`ClawdView`, `CloudView`, `TerminalView`, `HorseView`）的代码逻辑参考或派生自 [HermesPet](https://github.com/basionwang-bot/HermesPet)，遵循 [Apache 2.0](LICENSE.HermesPet) 协议。
